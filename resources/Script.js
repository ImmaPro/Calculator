...
var $number = $(".number");
 ...
 /* $zero.on('click', function() {if (click > 12){ return;} click++
var numberPressed =$(this.html())}) */

$number.on('click', function() { if (click > 12){ return;} click++;
  var numberPressed = $(this).html();
...
$("#equal").css('background-color','#000000');
  } });
...
$("#plus").on('click', function()
          { if (num1 != null) { more(); $screen.append("+"); op = "+";}; return; })

$("#minus").on('click', function()
          { if (num1 != null) { more(); $screen.append("-"); op = "-";}; return; })

$("#multiply").on('click', function()
          { if (num1 != null) { more(); $screen.append("x"); op = "*";}; return; })
...
$("#equal").on('click', function()
          {
            ...
            $screen.append(Math.floor(answer * 1000) / 1000);
